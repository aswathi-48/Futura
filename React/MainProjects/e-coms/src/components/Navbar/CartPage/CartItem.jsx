...
import { UpdateQuantity, deleteCartItems, postOrder } from '../../ApiCallll/ApiCall';
...
const CartItem = (props) => {
  ...
  return (
    <div key={props._id} className='cart__items'>
      ...
      <button className='buy__btn'><Link to={`/homeBuyNow/${title}`}className='link-buy' ><button onClick={orerHandler}>buynow</button></Link></button>
    </div>
  )
}
